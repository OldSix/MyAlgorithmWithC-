//
// Created by Queen on 2017/2/20.
//

#ifndef INC_02_RBTREE_RBTREE_DEFS_H
#define INC_02_RBTREE_RBTREE_DEFS_H
...
namespace RBTree
{
    ...
    protected:
        ...
        rbtree_node uncle(rbtree_node n) {
            ...
            assert(n->parent->parent != NULL); /* Childen of root have no uncle */
        ...
        void insert_case2(rbtree_node n) {
            if (node_color(n->parent) == BLACK) /* if parent color is black, then insert it. */
                return; /* Tree is strll valid */
            else
                insert_case3(n); /* parent color is Red */
        }

        void insert_case3(rbtree_node n) {
            if (node_color(uncle(n)) == RED) { /* parent color is Red and Uncle color is Red, too*/
...
#endif //INC_02_RBTREE_RBTREE_DEFS_H
